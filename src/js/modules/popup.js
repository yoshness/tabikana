...
export default function popup() {
	...
	const management = [
		...
		},
		{
			...
			userRole: '情報発信サポート',
			userMessage: '　私自身、アウトドアで行ったことない場所に行ったり、散歩やドライブで通ったことない道を通ったり、「移動」にとても楽しみを感じてきましたし、職業柄「ひとが移動することの意味」や「気軽に楽しく移動する方法」を考えてきました。<br>　そんな中「移動」を叶えるための別のアプローチに出会い、少しでも多くの方に、当プロジェクトを周知させたいと感じました。',
	...
	const sponsors = [
		...
		},
		{
			...
			userMessage: '　弊社では創業以来一貫してお身体の不自由な皆様へバーチャルツアーを提供してきました。 これまで本当に多くのご家族へ「笑顔になれるお手伝い」をさせて頂いている事を嬉しく思っています。<br>　私自身、祖父と父が病で寝たきりになり、病院で看取る経験しております。あのとき、この「夢叶」があれば私の家族にも選択肢が増えていたかもしれません。<br>今を生きている皆様に笑顔をお届けできるお手伝いをこのプロジェクトでも出来たら幸いです。',
