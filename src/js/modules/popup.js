...
export default function popup() {
	...
	const management = [
		{
			...
			userRole: 'プロジェクト代表',
			userMessage: '　これまで医師として、多くの方の“最期の瞬間”に立ち会いました。ある終末期患者さんの「旅行に行きたい」という言葉をきっかけに、「医療×旅行＝旅行医」をめざしました。<br>　 一人でも多くの願いを叶えるため、病気を抱えていても旅行ができる「医師のつくる旅行サポート会社」の設立を決意し、その最初の一歩としてこのプロジェクトを立ち上げました。<br>「旅行へ行きたい」を通じて「今を生きたい」人を応援します。 ',
			userProfile: '・昭和大学医学部医学科卒業<br>・洛和会音羽病院にて初期後期臨床研修<br>・東京都コンテスト「TOKYO STARTUP GATEWAY2019」にて1803件の応募から最優秀賞を受賞<br>・経済産業・省/JETRO主催「始動 Next Innovator 2019 」にて米国シリコンバレー派遣に選抜<br>・グロービス経営大学院 2019期生'
		},
		{
			userCategory: '運営チーム',
			...
			userRole: 'マネジメント',
			userMessage: '　幼い頃から“ばあちゃんっ子“だった私は社会人になっても遠くに住むばあちゃんによく会いに行っていました。バイバイ！と言うときはいつも「これで最後かもしれない…」そんな思いを持っていました。<br>　そんな中、突然の別れ。最期の瞬間にも会うことは出来ませんでした。後悔しないように生きていたつもりでしたが、残った感情は「もっとあんなことができたかもしれない」という後悔ばかり。覚悟をしていた自分でも後悔の念が強いということは、同じような気持ちを持つ方も多いのではないかと考えるようになりました。<br><br>「やり残したことをできないまま一生を終える人がいなくなるように。」<br>「後悔する家族が1人でも少なくなるように。」<br>プロジェクトを通じてそんな社会の実現を目指します。',
		...
		},
		{
			...
			userRole: '情報発信サポート',
			userMessage: '　私自身、アウトドアで自然を満喫したり通ったことのない道を散歩したり、「移動すること」や「非日常に身を置くこと」に強い喜びを感じて生活しています。また、職業柄から「ひとが移動することの意義」や「楽しく安心して移動する方法」を絶えず考えてきました。<br>　そんな中「移動」を叶えるための別アプローチであるこのプロジェクトに出会いました。少しでも多くの方に、このプロジェクトを知っていただきたく参画させていただいております。',
	...
	const medical = [
		...
		},
		{
			...
			userRole: '株式会社ハレ/代表',
			userMessage: '　病院や在宅の現場でいつも感じていたのは、「医療や介護が必要になっても、生きがいを感じながら過ごしてほしい」という事でした。<br>　そんな中、がん末期の義母とフォトウェディングを経験したことで、「私たち医療者が本気で支えれば、きっと実現できないことはない」と確信し、夢を叶える看護サービス『かなえるナース』を立ち上げました。<br>旅行に行きたいというあなたの夢を、私達が全力で支えます',
		...
		},
		{
			...
			userRole: 'リハビリ推進センター',
			userMessage: '　旅を諦めなかった余命3ヶ月の母、旅を諦めた患者さん、そして「生きがい」を探している患者さん。その出会いで、11年前に「リハビリ旅行」を創設しました。<br>　旅行はあくまで人生の通過点であり、そこに行くまでのプロセス(リハビリ)と、旅行後のサポートが重要と考えます。<br>今後も、旅行前～旅行中～旅行後まで諦めないでサポートし続けたいと考えております。その先の「生きがい」探しの為に‥。',
		...
		},
		{
			...
			userRole: 'ドリームケアサービス株式会社/代表',
			userMessage: '　都下の老人ホームで介護職として５年間勤務。 旅行や外出を諦めてしまっている方々を多く見ました。「家族に迷惑をかけたくない」「旅先で体調を崩すことが心配だ」など、不安や遠慮により諦めてしまっている方々の夢を叶えるため、外出サポート事業を起業しました。このプロジェクトを通じて、「旅を諦めない社会」を皆さんと一緒に実現したいと願っております。',
		...
		},
		{
			...
			userNameJa: '木原 正昭',
			userNameEn: 'Kihara Masaaki',
			userRole: 'かご屋/代表',
			userMessage: '　世界中の一人でも多くの人が、このプロジェクトを通して【安心・安全・安楽・感動】を感じて頂けるように全力でサポートさせて頂ければ幸いです。 介護旅行と聞くと大げさなものに感じますが、車椅子やストレッチャー(寝台)で何時間もかけて病院の通院をしている方が大勢います。<br>通院は出来るのに外出は出来ないと思い込んでいる方が非常に多いですよね。 通院も立派な外出ですが、たまには行先を変えて楽しみましょう！',
		...
		},
		{
			...
			userRole: '株式会社秋吉「夢旅」/代表',
			userMessage: '　私自身が15年前に車イスに乗った父を連れて介護旅行をした経験、かつ約10年介護施設を経営した中で外出や旅行に対する想いや夢を諦めているご利用者様やそのご家族様に多く接し「いつでも行きたい時に、行きたい場所に安心して気兼ねなく行ける世の中を創りたい！」という思いから5年前に高齢者の方に特化した旅行会社を立ち上げました。<br>このプロジェクトに参加し一人でも多くの想いや夢を叶えることができたら嬉しいです。',
	...
	const sponsors = [
		...
		// 	userRole: 'JALグループ',
		// 	userMessage: '　航空・観光事業に身を置き、主にお客様より、旅行が与えてくれる楽しさや幸せを肌で感じてきました。伊藤医師との出会いを通じて、その旅行を諦めてしまう方が沢山居ることを知りました。<br>　JALグループとして何かお手伝いができないかと考えていた中で、本プロジェクトに参加させていただくことができ大変嬉しく思っております。是非皆さんと一緒に、楽しく幸せな旅行を実現したいです。',
		...
		// },
		{
			...
			userNameJa: '白鳥 央',
			userNameEn: 'Shiratori Hisashi',
			userRole: '第一生命保険株式会社/イノベーション推進部',
			userMessage: '　本プロジェクトについて初めて伺ったとき、もし伊藤さんが目指す世界を実現すれば、病気を理由に色々なことを諦めざるを得ない状況にいらっしゃる方々にとって、旅行という選択肢が一筋の光になるのではという期待に胸が熱くなりました。治療や延命とは異なるQOL向上の手段の一つとして大いなる可能性を感じたからです。<br>本プロジェクトを通じて、人生に寄り添う役割を担っている生命保険会社としてからも、全力でサポートしていきます。',
		...
		},
		{
			...
			userMessage: '　グロービス経営大学院の同級生として出会った玲哉さんが目を輝かせながら語る夢に、感動で心が震え、涙が止まりませんでした。<br>末期ガンの母を介護している個人としても、また損害保険会社で旅行保険を専門に扱う部門に所属している企業人としても、玲哉さんの強い想いを全力で応援します。',
		...
		},
		{
			...
			userRole: '株式会社ラブグラフ/代表取締役',
			userMessage: '　ラブグラフではご家族の写真はもちろん、新たな生命の誕生を写真におさめるためマタニティフォトやニューボーンフォトにも特に注力してまいりました。<br>一方で、どのようにして『人生の最期の瞬間に向き合うか』は常に向き合ってきた課題でした。<br>この度、そこに映る患者様、家族の皆様の笑顔を残せる未来を鮮明に描くことができたため、旅叶プロジェクトと協働させていただきます。<br>『今を生きた証』をラブグラフが心を込めて映し出します。',
		...
		},
		{
			...
			userRole: '株式会社シアン/代表取締役',
			userMessage: '　弊社では創業以来一貫してお身体の不自由な皆様へバーチャルツアーを提供してきました。 これまで本当に多くのご家族へ「笑顔になれるお手伝い」をさせて頂いている事を嬉しく思っています。<br>　私自身、祖父と父が病で寝たきりになり、病院で看取る経験しております。あのとき、この「たびかな」があれば私の家族にも選択肢が増えていたかもしれません。<br> 今を生きている皆様に笑顔をお届けできるお手伝いをこのプロジェクトでも出来たら幸いです。',
